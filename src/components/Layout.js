...
export default class Body extends React.Component {
    render() {
        ...
        if (_.get(this.props, 'page.frontmatter.seo.title', null)) {
             title = _.get(this.props, 'page.frontmatter.seo.title', null);
        }
        if (_.get(this.props, 'page.frontmatter.seo.canonical_url', null)) {
             canonical_url = _.get(this.props, 'page.frontmatter.seo.canonical_url', null);
        }
        return (
            <React.Fragment>
                <Helmet>
